...
std::shared_ptr<ISimulator>
SimulatorsFactory::CreateSimulator(SimulatorType t, SimulationType m) {
  switch (t) {
...
std::unique_ptr<ISimulator>
SimulatorsFactory::CreateSimulatorUnique(SimulatorType t, SimulationType m) {
  switch (t) {
  case SimulatorType::kQCSim: {
