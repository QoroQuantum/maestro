...
extern "C" 
{
    ...
    __declspec(dllexport)
#endif
    int ApplyU(void* sim, int qubit, double theta, double phi,
    ...
    __declspec(dllexport)
#endif
    int ApplyCP(void* sim, int controlQubit, int targetQubit,
        double theta) {
        if (!sim)
            return 0;
        auto simulator = static_cast<Simulators::ISimulator*>(sim);
    ...
    __declspec(dllexport)
#endif
    int ApplyCRx(void* sim, int controlQubit, int targetQubit,
        double theta) {
        if (!sim)
            return 0;
        auto simulator = static_cast<Simulators::ISimulator*>(sim);
    ...
    __declspec(dllexport)
#endif
    int ApplyCRy(void* sim, int controlQubit, int targetQubit,
        double theta) {
        if (!sim)
            return 0;
        auto simulator = static_cast<Simulators::ISimulator*>(sim);
    ...
    __declspec(dllexport)
#endif
    int ApplyCRz(void* sim, int controlQubit, int targetQubit,
        double theta) {
        if (!sim)
            return 0;
        auto simulator = static_cast<Simulators::ISimulator*>(sim);
    ...
    __declspec(dllexport)
#endif
    int ApplyCU(void* sim, int controlQubit, int targetQubit,
    ...
    __declspec(dllexport)
#endif
    int ConfigureSimulator(void* sim, const char* key,
        const char* value) {
        if (!sim || !key || !value)
            return 0;
        auto simulator = static_cast<Simulators::ISimulator*>(sim);
