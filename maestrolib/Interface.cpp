...
extern "C" int
RemoveAllOptimizationSimulatorsAndAdd(unsigned long int simHandle, int simType,
                                      int simExecType) {
  if (!maestroInstance || simHandle == 0)
    return 0;
...
extern "C" int AddOptimizationSimulator(unsigned long int simHandle,
...
extern "C" char *SimpleExecute(unsigned long int simpleSim,
                               const char *circuitStr, const char *jsonConfig) {
...
extern "C" int ApplyU(void *sim, int qubit, double theta, double phi,
...
extern "C" int ApplyCP(void *sim, int controlQubit, int targetQubit,
                       double theta) {
  if (!sim)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" int ApplyCRx(void *sim, int controlQubit, int targetQubit,
                        double theta) {
  if (!sim)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" int ApplyCRy(void *sim, int controlQubit, int targetQubit,
                        double theta) {
  if (!sim)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" int ApplyCRz(void *sim, int controlQubit, int targetQubit,
                        double theta) {
  if (!sim)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" int ApplyCCX(void *sim, int controlQubit1, int controlQubit2,
                        int targetQubit) {
  if (!sim)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" int ApplyCU(void *sim, int controlQubit, int targetQubit,
...
extern "C" int ConfigureSimulator(void *sim, const char *key,
                                  const char *value) {
  if (!sim || !key || !value)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" unsigned long int AllocateQubits(void *sim,
...
extern "C" unsigned long long int Measure(void *sim,
...
extern "C" int ApplyReset(void *sim, const unsigned long int *qubits,
                          unsigned long int nrQubits) {
  if (!sim || !qubits || nrQubits == 0)
    return 0;
  auto simulator = static_cast<Simulators::ISimulator *>(sim);
...
extern "C" double *Probabilities(void *sim,
...
SampleCounts(void *sim, const unsigned long long int *qubits,
